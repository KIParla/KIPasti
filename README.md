...
The KIPasti corpus is part of the larger [KIParla collection](https://www.kiparla.it),
...
2. Conversations metadata:
   ...
   - `type`: type of interaction, for this module all conversation are `free-conversations`
   ...
   - `participants-relationship`: relation, symmetric for this module
...
> Mauri, C., Ballarè, S., & Zucchini, E. (2024). Modulo KIPasti (Version 1.0.0) [Data set]. https://doi.org/https://doi.org/10.60760/unibo/kipasti.
...
```bibtex
	@misc{Mauri_Modulo_KIPasti_2024,
		...
		doi = {https://doi.org/10.60760/unibo/kipasti.},
		month = oct,
